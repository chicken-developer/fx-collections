...
parentPath = r'C:/Users/quynh/OneDrive/Documents/maya/projects/ASSETS/ninja'

mp = os.path.join(parentPath, 'model', 'ninja_model.mb')
gp = os.path.join(parentPath, 'guides', 'ninja_guides.mb')
...
control_data_path = os.path.join(parentPath, 'control_data')
weight_data_path = os.path.join(parentPath, 'weight_data')
